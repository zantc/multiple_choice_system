...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'delete_question') {
        ...
        flashAndRedirect('success', 'Đã ẩn câu hỏi!', $query_str);
    }
...
$pageTitle = "Ngân hàng câu hỏi | Online Quiz";
$headerIcon = "fa-solid fa-file-circle-question";
...
<div class="container">
    ...
    <div class="page" style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px; margin-bottom: 20px;">
        <div class="card" style="margin:0;">
            <h3><i class="fa-solid fa-filter"></i> Bộ lọc & Tìm kiếm</h3>
            <form method="GET" style="display: grid; grid-template-columns: 1fr 2fr auto; gap: 10px; align-items: flex-end;">
                <div>
                    <label style="font-size: 12px;">Môn học</label>
                    <select name="subject_id" style="padding: 10px;">
                ...
                <div>
                    <label style="font-size: 12px;">Nội dung câu hỏi</label>
                    <input type="text" name="search" value="<?= htmlspecialchars($search, ENT_QUOTES, 'UTF-8') ?>" placeholder="Nhập từ khóa cần tìm..." style="padding: 10px;">
                </div>
        ...
        <div class="card" style="margin:0;">
            <h3><i class="fa-solid fa-file-csv"></i> Nhập từ CSV</h3>
            <form method="POST" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 8px;">
                <?= csrf_field() ?>
                <input type="hidden" name="action" value="import_csv">
                
                <select name="import_subject_id" required style="padding: 8px; font-size: 12px;">
                ...
                <input type="file" name="csv_file" accept=".csv" required style="font-size: 12px; padding: 4px;">
    ...
    <div class="card">
        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--line); padding-bottom: 12px; margin-bottom: 15px;">
            <h3 style="margin: 0; border: none; padding: 0;">Danh sách câu hỏi</h3>
