...
function analyticsUrl(array $overrides = []): string
{
    ...
    return 'teacher_analytics.php' . ($params ? '?' . http_build_query($params) : '');
}
...
if ($export === 'excel') {
    $filename = 'bao_cao_giao_vien_' . date('Ymd_His') . '.xls';
    ...
    <body>
        <h1>Báo cáo giám sát và thống kê - Giáo viên</h1>
...
if ($export === 'pdf') {
    ...
    <head>
        <meta charset="UTF-8">
        <title>Báo cáo giám sát và thống kê - Giáo viên</title>
        <style>
    ...
    <body>
        <div class="toolbar">
            ...
            <a href="teacher_analytics.php">Quay lại</a>
        </div>
        <h1>Báo cáo giám sát và thống kê - Giáo viên</h1>
        <p>Xuất lúc: <?= h(date('d/m/Y H:i')) ?></p>
        <?php renderExportTables($sessions, $subjectStats, $classStats, $studentStats, $resultRows); ?>
...
$pageTitle = "Phân tích kết quả & Thống kê | Portal Giáo viên";
$hideNavbar = true;
...
<div class="main-content">
    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid var(--line); padding-bottom: 15px; margin-bottom: 20px; flex-wrap: wrap; gap: 15px;">
        <div>
            <h1 style="margin: 0; color: var(--sidebar-bg); font-size: 24px;">
                <i class="fa-solid fa-chart-line" style="color: var(--primary);"></i> Phân tích kết quả & Thống kê
            </h1>
            <p style="margin: 4px 0 0; color: var(--muted); font-size: 13px;">Theo dõi tiến độ, phân phối phổ điểm và hiệu suất làm bài thi của học viên.</p>
        </div>
        <div style="display: flex; gap: 10px;">
            <a class="btn btn-success" style="padding: 10px 15px; font-size:13px;" href="<?= h(analyticsUrl(['export' => 'excel'])) ?>"><i class="fa-solid fa-file-excel"></i> Xuất Excel</a>
            <a class="btn btn-danger" style="padding: 10px 15px; font-size:13px;" href="<?= h(analyticsUrl(['export' => 'pdf'])) ?>" target="_blank"><i class="fa-solid fa-file-pdf"></i> Xuất PDF / In ấn</a>
        </div>
    </div>
    ...
    <div class="card" style="margin-bottom: 20px;">
        ...
        <form method="GET" class="filters" style="margin: 0;">
            ...
            <div style="display: flex; gap: 8px;">
                ...
                <a class="btn btn-secondary" href="teacher_analytics.php" style="padding: 10px; font-size:13px;" title="Đặt lại"><i class="fa-solid fa-rotate-left"></i></a>
            </div>
        </form>
    </div>
