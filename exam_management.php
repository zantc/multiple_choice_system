...
$pageTitle = "Quản lý kỳ thi | Online Quiz System";
$headerIcon = "fa-solid fa-calendar-days";
$headerTitle = "Quản lý kỳ thi";
...
<div class="container">
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 16px;">
        <div>
            <h2 style="margin: 0 0 4px; font-size: 22px;">Kỳ thi & Lịch thi</h2>
            <p style="margin: 0; color: var(--muted); font-size: 13px;">Tạo kỳ thi, gán đề, đặt khoảng thời gian khả dụng và chỉ định lớp tham gia.</p>
        </div>
        <a href="system_reports.php" class="btn btn-warning" style="font-size: 13px;"><i class="fa-solid fa-chart-line"></i> Xem Báo cáo thống kê</a>
    </div>
        ...
        <section>
            <div class="panel">
                ...
                <form method="POST">
                    ...
                    <input id="title" type="text" name="title" value="<?= h($formSession['title']) ?>" placeholder="Ví dụ: Thi giữa kỳ môn Toán" required style="padding: 10px;">

                    <label for="exam_id">Đề thi gốc</label>
                    <select id="exam_id" name="exam_id" required style="padding: 10px;">
                    ...
                    <div class="row time-row">
                        <div>
                            <label for="start_time">Thời gian Mở đề</label>
                            <input id="start_time" type="datetime-local" name="start_time" value="<?= h(toDateTimeLocal($formSession['start_time'])) ?>" required style="padding: 10px;">
                        </div>
                        <div>
                            <label for="end_time">Thời gian Đóng đề</label>
                            <input id="end_time" type="datetime-local" name="end_time" value="<?= h(toDateTimeLocal($formSession['end_time'])) ?>" required style="padding: 10px;">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div>
                            ...
                            <select id="mode" name="mode" style="padding: 10px;">
                        ...
                        <div>
                            ...
                            <input id="max_attempts" type="number" name="max_attempts" min="1" max="99" value="<?= h($formSession['max_attempts']) ?>" required style="padding: 10px;">
                        </div>
                    </div>
                    ...
                    <?php else: ?>
                        <div class="empty">Chưa có lớp học/nhóm nào. Hãy tạo ở danh mục quản lý lớp hoặc form dưới.</div>
                    <?php endif; ?>
                    ...
                    <div class="form-actions">
                        ...
                        <?php if ($editingSession): ?>
                            <a class="btn btn-danger" href="exam_management.php" style="padding: 11px;">
                                Hủy
                            </a>
                        <?php endif; ?>
                    </div>
            ...
            <div class="panel">
                <h3><i class="fa-solid fa-users-viewfinder"></i> Tạo nhanh nhóm học viên thi</h3>
                <form method="POST">
                    <?= csrf_field() ?>
                    <input type="hidden" name="action" value="create_group">

                    <label for="group_name">Tên lớp / Nhóm đặc biệt</label>
                    <input id="group_name" type="text" name="group_name" placeholder="Ví dụ: Nhóm thi lại Lần 2" required style="padding: 10px;">

                    <div class="row">
                        <div>
                            <label for="subject_id">Môn học</label>
                            <select id="subject_id" name="subject_id" style="padding: 10px;">
                        ...
                        <div>
                            ...
                            <input id="school_year" type="text" name="school_year" placeholder="2025-2026" style="padding: 10px;">
                        </div>
                    </div>
                        ...
                        <tbody>
                            <?php foreach ($sessions as $session): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            <a class="btn btn-warning" style="padding: 6px 10px;" href="exam_management.php?edit=<?= h($session['id']) ?>" title="Sửa thông tin kỳ thi">
                                            ...
                                            <form method="POST" style="display:inline;" onsubmit="return confirm('Xóa kỳ thi này hoàn toàn khỏi danh sách?');">
                                                <?= csrf_field() ?>
