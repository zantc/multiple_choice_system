...
// được lưu trong file config/.env.php (KHÔNG commit lên Git).
// =============================================
...
if (!file_exists($envPath)) {
    die(
        ...
        . '<p>Copy the <code>config/.env.example.php</code> file to <code>config/.env.php</code> and fill in the real information.</p>'
    );
}
