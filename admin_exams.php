...
// --- LẤY DỮ LIỆU ---
// Hỗ trợ fallback max_score nếu không tồn tại cột max_score
$exams = $pdo->query("
...
$pageTitle = "Quản lý đề thi | Online Quiz";
$headerIcon = "fa-solid fa-file-lines";
$headerTitle = "Quản lý đề thi";
...
<div class="container">
    ...
    <div class="card">
        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--line); padding-bottom: 12px; margin-bottom: 16px;">
            <h3 style="margin: 0; border: none; padding: 0;">Danh sách đề thi cấu trúc</h3>
    ...
    <div class="page" style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 20px; margin-top: 20px;">
        <div class="card" style="margin:0;">
            <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--line); padding-bottom: 12px; margin-bottom: 16px;">
                ...
                <a href="admin_exams.php" class="btn btn-warning" style="font-size:12px;"><i class="fa-solid fa-xmark"></i> Đóng</a>
            </div>
        ...
        <div class="card" style="margin:0;">
            ...
            <form method="POST" style="background: #f8fafc; padding: 12px; border-radius: 8px; border: 1px solid var(--line);">
                <?= csrf_field() ?>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 12px;">
                    <div>
                        <label style="font-size: 11px; font-weight:600; color:var(--success);">Số câu Dễ</label>
                        <input type="number" name="num_easy" value="0" min="0" style="padding: 6px; margin: 0; font-size:13px;">
                    </div>
                    <div>
                        <label style="font-size: 11px; font-weight:600; color:#d97706;">Số câu TB</label>
                        <input type="number" name="num_medium" value="0" min="0" style="padding: 6px; margin: 0; font-size:13px;">
                    </div>
                    <div style="grid-column: span 2;">
                        <label style="font-size: 11px; font-weight:600; color:var(--danger);">Số câu Khó</label>
